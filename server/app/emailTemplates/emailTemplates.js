...
const peerReviewEmailTemplate = peerName => {
  return `<html><body><h4>Hello ${peerName} 
...
const updatePasswordTemplate = (user, link) => {
  return `<html><body><h4>Hello ${user}, </h4><p>Your password has been updated.</p>
${thanksNote}</body></html>`;
};

module.exports = {
  peerReviewEmailTemplate,
  newUserTemplate,
